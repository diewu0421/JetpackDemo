...
public class DampLayout extends LinearLayout
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e("DampLayout", "onMeasure: parent height = " + getMeasuredHeight() + "  rv.height = " + params.height);
    ...
    public void onNestedPreScroll(@NonNull View target, int dx, int dy, @NonNull int[] consumed, int type) {
        ...
        Log.e("DampLayout", "onNestedPreScroll: "+ type);
    ...
    public boolean onNestedFling(View target, float velocityX, float velocityY, boolean consumed) {
        Log.e("DampLayout", "onNestedFling: " + consumed);
        return true;
    }

    @Override
    public boolean onNestedPreFling(View target, float velocityX, float velocityY) {
        Log.e("DampLayout", "onNestedPreFling: ");
        return false;
    }

    @Override
    public void onNestedScroll(@NonNull View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int type) {
        Log.e("DampLayout", "onNestedScroll: " + type);
        getParent().requestDisallowInterceptTouchEvent(true);
